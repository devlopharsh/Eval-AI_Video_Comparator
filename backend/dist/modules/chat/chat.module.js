...
exports.ChatModule = ChatModule = __decorate([
    (0, common_1.Module)({
        imports: [qdrant_module_1.QdrantModule],
        controllers: [chat_controller_1.ChatController],
        providers: [chat_service_1.ChatService, openai_generation_service_1.OpenAiGenerationService, chat_workflow_service_1.ChatWorkflowService],
    })
], ChatModule);
