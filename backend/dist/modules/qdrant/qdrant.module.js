...
exports.QdrantModule = QdrantModule = __decorate([
    (0, common_1.Module)({
        providers: [qdrant_service_1.QdrantService, embedding_service_1.EmbeddingService],
        exports: [qdrant_service_1.QdrantService, embedding_service_1.EmbeddingService],
    })
], QdrantModule);
